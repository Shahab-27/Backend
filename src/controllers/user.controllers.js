...
const refreshAccessToken = asyncHandler(async(req,res) => {
    ...
    try {
        // here decoding the token to get the payload(data)
        // that usually constains the ._id
        ...
        const options = {
            //  true means the cookie is inaccessible to JavaScript on the client side
            httpOnly: true,  
            secure: true
        }
...
const updateAccountDetails = asyncHandler(async(req, res) => {
    ...
    const user = await User.findByIdAndUpdate(
        ...
        {new: true}
        //true means after updation it will return the value
